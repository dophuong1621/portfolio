...
📧 **Email:** [${a.email}](mailto:${a.email})
💬 **Zalo:** [${a.phone}](${a.zaloUrl})`:i("sở thích","hobby","hobbies","ngoài công việc","outside work","nhiếp ảnh","photo","bóng đá","football","ai","sáng tạo","ngoại khoá","ngoai khoa","extracurricular","thể thao","sport","pickleball","cầu lông","badminton","chạy bộ","running","hoạt động")?`🌟 **Ngoài công việc, Phương:**
...
Phương là người năng động, hoà đồng và gắn kết tốt với văn hoá công ty! 😄`:i("system design","thiết kế hệ thống","kiến trúc","architecture","hiệu năng","performance","metric","con số")?`📊 **System Architecture & Performance:**
